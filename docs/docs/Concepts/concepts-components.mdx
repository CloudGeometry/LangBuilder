...
For example, the [**Recursive Character Text Splitter** component](https://github.com/langbuilder-ai/langbuilder/blob/main/src/backend/base/langbuilder/components/langchain_utilities/recursive_character.py) is a child of the [`LCTextSplitterComponent`](https://github.com/langbuilder-ai/langbuilder/blob/main/src/backend/base/langbuilder/base/textsplitters/model.py) class.
