...
For an example Langbuilder JSON file, examine the [Basic Prompting.json](https://github.com/langbuilder-ai/langbuilder/blob/main/src/backend/base/langbuilder/initial_setup/starter_projects/Basic%20Prompting.json) file in the Langbuilder repository.
