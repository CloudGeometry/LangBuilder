...
The schema is defined in [`data.py`](https://github.com/langbuilder-ai/langbuilder/blob/main/src/backend/base/langbuilder/schema/data.py).
...
The schema is defined in [`dataframe.py`](https://github.com/langbuilder-ai/langbuilder/blob/main/src/backend/base/langbuilder/schema/dataframe.py).
...
The `Message` schema is defined in [`message.py`](https://github.com/langbuilder-ai/langbuilder/blob/main/src/backend/base/langbuilder/schema/message.py).
Some `Message` attributes have their own schema definitions, such as [`content_block.py`](https://github.com/langbuilder-ai/langbuilder/blob/main/src/backend/base/langbuilder/schema/content_block.py).
