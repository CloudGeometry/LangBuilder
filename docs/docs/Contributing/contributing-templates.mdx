...
For template formatting examples, see [`/starter_projects`](https://github.com/langbuilder-ai/langbuilder/tree/main/src/backend/base/langbuilder/initial_setup/starter_projects) in the Langbuilder repository.

## Create a PR to submit your template

Follow these steps to submit your template:

1. Fork the [Langbuilder repository](https://github.com/langbuilder-ai/langbuilder) on GitHub.
...
For more information, see the Langbuilder repository's [template categories](https://github.com/langbuilder-ai/langbuilder/blob/main/src/frontend/src/modals/templatesModal/index.tsx#L27-L57).