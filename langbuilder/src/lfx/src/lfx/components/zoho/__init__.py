"""Zoho components for LangBuilder — Zoho Recruit ATS API integration."""
...
_dynamic_imports = {
    "ZohoRecruitAttachmentComponent": "zoho_recruit_attachment",
    "ZohoRecruitAuthComponent": "zoho_recruit_auth",
    "ZohoRecruitCandidateComponent": "zoho_recruit_candidate",
    "ZohoRecruitJobOpeningComponent": "zoho_recruit_job_opening",
    "ZohoRecruitNotesComponent": "zoho_recruit_notes",
}
...
def __getattr__(attr_name: str) -> Any:
    """Lazily import Zoho components on attribute access."""
